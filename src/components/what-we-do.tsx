...
export default function WhatWeDo() {
  return (
    <div>
      ...
      <div className="h-[700px] bg-cream-default text-dark-green-default font-founders">
        <div className="flex flex-column w-fit">
          ...
          <div className="translate-y-10 max-w-xl">
              ...
              <h2 className="text-2xl">Saturday, 15.30 - 17.00 </h2>
              <p className="text-xl">
            ...
            <div className="translate-y-10 max-w-xl">
              ...
              <div className="h-[2px] w-[312px] bg-dark-green-default -translate-y-1"></div>
              <h2 className="text-2xl">Saturday, 13.00 - 15.00 </h2>
              <p className="text-xl">
                Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                Repudiandae architecto delectus neque suscipit cum, consequatur
                eos cupiditate voluptates aliquam. Ipsum cum officiis delectus
            ...
            <div className="translate-y-10 max-w-xl">
              ...
              <div className="h-[2px] w-[312px] bg-dark-green-default -translate-y-1"></div>
              <h2 className="text-2xl">Thursday, 19.00 - 21.00 </h2>
              <p className="text-xl">
                Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                Repudiandae architecto delectus neque suscipit cum, consequatur
                eos cupiditate voluptates aliquam. Ipsum cum officiis delectus
            ...
            <div className="translate-y-10 max-w-xl">
              ...
              <div className="h-[2px] w-[312px] bg-dark-green-default -translate-y-1"></div>
              <h2 className="text-2xl">Friday, 18.30 - 21.00 </h2>
              <p className="text-xl">
                Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                Repudiandae architecto delectus neque suscipit cum, consequatur
                eos cupiditate voluptates aliquam. Ipsum cum officiis delectus
