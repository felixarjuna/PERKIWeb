    ...
    <AnimatePresence>
      {showNav ? (
        ...
        >
          ...
          >
            <span className="flex items-center justify-center rounded-lg bg-gradient-to-r from-light-green-default/50 to-green-default p-[2px] 2xl:h-8 2xl:w-8 xs:h-6 xs:w-6 xs:p-[1px]">
