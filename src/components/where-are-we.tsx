    ...
    <>
      <div className="bg-cream-default text-dark-green-default">
        <div className="relative">
          <h1 className="text-9xl text-green-default text-center absolute inset-0 mx-auto top-20 font-reimbrandt xs:text-4xl xs:z-20">
            Where Are We
          </h1>
          ...
          <div className="absolute bg-green-default/80 h-full w-[1/3] 2xl:w-1/4 bottom-0 left-0 text-cream-default text-2xl flex flex-col justify-center gap-y-8 px-16 2xl:px-20 z-10 xs:text-sm xs:w-full xs:h-1/3">
            <div>
